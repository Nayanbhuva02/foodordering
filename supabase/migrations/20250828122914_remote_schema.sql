...
CREATE POLICY "All authenticated users All operations" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "allow authenticated users to access" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);
